...
namespace ACESinspector
{
    ...
    {// one of these holds the entire contents of the imported ACES file - along with the results of analysis. The methods for analysis are also here. the rationale for containerizing the data is for future 
        ...
        {// populate XSD's as strings in a string/string dictionary.
            ...
            noteBlacklist.Add("RWD", false); noteBlacklist.Add("FWD", false); noteBlacklist.Add("2WD", false); noteBlacklist.Add("4WD", false); noteBlacklist.Add("Turbo", false);
            noteBlacklist.Add("Gas", false); noteBlacklist.Add("Diesel", false); noteBlacklist.Add("CNG", false); noteBlacklist.Add("Flex", false); noteBlacklist.Add("2 Door", false);
            noteBlacklist.Add("3 Door", false); noteBlacklist.Add("4 Door", false); noteBlacklist.Add("5 Door", false); noteBlacklist.Add("6 Door", false); noteBlacklist.Add("2 Dr", false);
            noteBlacklist.Add("3 Dr", false); noteBlacklist.Add("4 Dr", false); noteBlacklist.Add("Sedan", false); noteBlacklist.Add("Wagon", false); noteBlacklist.Add("Coup", false); noteBlacklist.Add("Rear Disc", false);
            noteBlacklist.Add("Maunal", false); noteBlacklist.Add("Automatic", false); noteBlacklist.Add("Speed", false); noteBlacklist.Add("Rear Drum", false); noteBlacklist.Add("Dohc", false); noteBlacklist.Add("Sohc", false);
            noteBlacklist.Add("ohv", false); noteBlacklist.Add("V4", false); noteBlacklist.Add("V6", false); noteBlacklist.Add("V8", false); noteBlacklist.Add("V10", false); noteBlacklist.Add("L2", false); noteBlacklist.Add("L3", false);
