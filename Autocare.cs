...
default: return 0;
        ...
        public void recordAnalysisResults(string vcdbVersion, string pcdbVersion)
        {
            ...
            key.SetValue(fileMD5hash, "fileName:" + Path.GetFileName(filePath) + ";ACESversion:" + version + ";validatedAgainstVCdb:" + vcdbVersion + ";validatedAgainstPCdb:" + pcdbVersion + ";errorCount:" + (parttypePositionErrorsCount+vcdbCodesErrorsCount+vcdbConfigurationsErrorsCount+basevehicleidsErrorsCount+qdbErrorsCount+vcdbConfigurationsErrorsCount).ToString() + ";warningCount:" + (parttypeDisagreementCount+qtyOutlierCount).ToString() + ";applicationCount:" + apps.Count.ToString() + ";partCount:" + partsAppCounts.Count.ToString() + ";");
        }
